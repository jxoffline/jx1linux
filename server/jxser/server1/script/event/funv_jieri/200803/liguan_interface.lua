...
--by 小浪多多
--2007-09-06
Include("\\script\\event\\funv_jieri\\200803\\head.lua");
Include( "\\script\\task\\system\\task_string.lua" );

function funv_jieri200803_main()
	...
	for i=1,tbtemp.nselectsum do
		local szstr = format("szselect%d",i) 
		arytalk[getn(arytalk)+1] = tbtemp[szstr]
	end
...
function tbclassname:makeItemUI(nsign)
	...
	if self:checkFreeCount(2) == 0 then
