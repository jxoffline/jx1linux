...
TEMBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,7 ,"bug_exp"))  --Ğ¡¹Ö¾­Ñé
TEMBUGBEAR_MAPID= 392  --É½ÉñÃíµÄµØÍ¼id
TEMBUGBEAR_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,7 ,"bug_jifen"))  --Ğ¡¹Ö¾­Ñé
