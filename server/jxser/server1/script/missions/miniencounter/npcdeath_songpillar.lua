...
function CreateNpcTimer(nSubWorldIdx)
	...
	-- Ë¢ĞÅÏ¢
	tbMap:Msg2Camp(1, "Thèng so¸i phe ta ®· dùng l¹i cê Nguyªn So¸i, hìi c¸c chiÕn sÜ h·y mau chãng ®Õn b¶o vÖ!");
	tbMap:Msg2Camp(2, "Thèng so¸i phe Tèng ®· dùng l¹i cê Nguyªn So¸i, hìi c¸c chiÕn sÜ h·y mau chãng c­íp cê tr¶m t­íng!");
...
function OnDeath(nNpcIndex)
	...
	local nMapId = SubWorldIdx2ID(nSubWorldIdx);						-- µØÍ¼ID
	...
	-- Ë¢ĞÅÏ¢
	local strMsg = "Phe Kim lùc l­îng hïng m¹nh, ®· tr¶m %s cê chiÕn cña phe Tèng, phe Kim ®­îc 1 ®iÓm, phe Tèng mÊt 1 ®iÓm.";
--	local strMsg = "½ğ·½ÊÆÈçÆÆÖñ£¬%sÕ¶¶ÏÁËËÎ·½µÄÕ½Æì£¬ËÎ·½Ê§È¥1·Ö¡£";
