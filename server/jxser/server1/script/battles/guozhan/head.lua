...
--		WriteLog("ÓÉÓÚ°Ü·½Ã»ÓÐÍæ¼Ò£¬ËùÒÔÊ¤Àû·½²»ËÍ½±Àø")
--		return
--	end
...
if (camp == 1) then
	...
	EnterChannel(PlayerIndex, "Phe Tèng"..szGAME_GAMELEVEL[level].."Quèc chiÕn tèng kim")
else
	posx = GetMissionV(MS_HOMEIN_X2)
	posy = GetMissionV(MS_HOMEIN_Y2)
	str = GetName().."Gia nhËp phe Kim"
	EnterChannel(PlayerIndex, "Phe Kim"..szGAME_GAMELEVEL[level].."Quèc chiÕn tèng kim")
end
