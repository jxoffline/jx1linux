...
function exchange_lingpai2goldequip()
	local aryDescribe =
	{
		...
		format("Bé trang bÞ Minh Phông/#take_xp_equip_1(9, %d)", 2745),
		format("Bé trang bÞ §»ng Long/#take_xp_equip_1(10, %d)", 2975),
		"L¸t n÷a quay l¹i /no",
	};
...
function take_xp_equip_1(n_g, n_d)
	...
	CreateTaskSay({"<dec><npc>§¹i hiÖp muèn ®æi trang bÞ cña hÖ ph¸i nµo bªn d­íi:", 
						...
						format("§­êng M«n tô tiÔn/#take_xp_equip_2(%d,%d, 15)", n_g, n_d),
...
function take_xp_equip_11(n_g, n_d)
	CreateTaskSay({"<dec><npc>§¹i hiÖp muèn ®æi trang bÞ cña hÖ ph¸i nµo bªn d­íi:", 
						...
						format("Hoa S¬n KiÕm T«ng/#take_xp_equip_2(%d,%d, 24)", n_g, n_d),
						format("Hoa S¬n KhÝ T«ng/#take_xp_equip_2(%d,%d, 25)", n_g, n_d),
