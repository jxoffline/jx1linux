...
TUREBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,8 ,"bug_exp"))  --Ð¡¹Ö¾­Ñé
TUREBUGBEAR_MAPID= 393  --Ç§±¦¿âµÄµØÍ¼id
TUREBUGBEAR_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,8 ,"bug_jifen"))  --Ð¡¹Ö¾­Ñé
