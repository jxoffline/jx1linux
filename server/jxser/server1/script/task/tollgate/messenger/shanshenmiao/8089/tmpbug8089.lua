...
TEMBUGBEAR_EXP =tonumber( TabFile_GetCell( "tollprize" ,6 ,"bug_exp"))  --Ğ¡¹Ö¾­Ñé
TEMBUGBEAR_MAPID= 391  --É½ÉñÃíµÄµØÍ¼id
TEMBUGBEAR_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,6 ,"bug_jifen"))  --Ğ¡¹Ö¾­Ñé
