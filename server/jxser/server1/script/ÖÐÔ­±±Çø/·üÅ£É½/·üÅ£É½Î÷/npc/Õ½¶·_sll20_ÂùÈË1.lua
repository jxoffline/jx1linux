-- ½£¸óÊñµÀ Õ½¶·NPC ÂùÈË1 ÉÙÁÖ20¼¶ÈÎÎñ
-- by£ºDan_Deng(2003-08-01)

function OnDeath()
	UTask_sl = GetTask(7);
	if (UTask_sl >= 20*256+64) and (UTask_sl < 20*256+128) and (GetBit(UTask_sl,1) == 0) then			-- ÈÎÎñÖĞÇÒÕâÒ»Ö»Î´´ò¹ı
		UTask_sl = SetBit(UTask_sl,1,1)
