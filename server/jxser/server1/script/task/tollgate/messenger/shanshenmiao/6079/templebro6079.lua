...
-- Desc			:   É½ÉñÃí¹Ø¿¨µÄµ¶ÑıĞÖµÜËÀÍö½Å±¾[60-79¼¶]
-------------------------------------------------------------------------
IncludeLib( "FILESYS" );
...
TEMREFRESH_EXP =tonumber( TabFile_GetCell( "tollprize" ,5 ,"shuachu_exp"))  --Ğ¡¹Ö¾­Ñé
TEMREFRESH_MAPID= 390  --É½ÉñÃíµÄµØÍ¼id
TEMREFRESH_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,5 ,"shuachu_jifen"))  --Ğ¡¹Ö¾­Ñé
...
function OnDeath()
	...
	if (  messenger_middletime() == 10 ) then --Íæ¼ÒÔÚµØÍ¼ÖĞµÄÊ±¼ä
		Msg2Player("ThËt xin lçi ! "..name.."! Ng­¬i ®· hÕt thêi gian lµm nhiÖm vô tİn sø, nhiÖm vô thÊt b¹i !.")
		losemessengertask()
