--PhÇn th­ëng exp khi sö dông S­ B× §¬n
tbUseAward2_Exp=
{
	{szName = "§iÓm Kinh NghiÖm", nExp=6000000,nRate=68},
	{szName = "§iÓm Kinh NghiÖm", nExp=7000000,nRate=30},
	{szName = "§iÓm Kinh NghiÖm", nExp=12000000,nRate=2},
}
--PhÇn th­ëng exp khi sö dông Ch©n Long §¬n
tbUseAward3_Exp=
{
	{szName = "§iÓm Kinh NghiÖm", nExp=8000000,nRate=20},
	{szName = "§iÓm Kinh NghiÖm", nExp=10000000,nRate=63},
	{szName = "§iÓm Kinh NghiÖm", nExp=20000000,nRate=10},
	{szName = "§iÓm Kinh NghiÖm", nExp=50000000,nRate=5},
	{szName = "§iÓm Kinh NghiÖm", nExp=100000000,nRate=2},	
}
...
tbAward_Old = {--server cò
	...
	-- {szName="Hé M¹ch §¬n",tbProp={6,1,3203,1,0,0},nCount=50,nRate=5},
	...
	-- {szName="HuyÕt Long §»ng CÊp 5",tbProp={6,1,30289,5,0,0},nCount=1,nRate=2},
	-- {szName="HuyÕt Long §»ng CÊp 6",tbProp={6,1,30289,6,0,0},nCount=1,nRate=2},
	-- {szName="HuyÕt Long §»ng CÊp 8",tbProp={6,1,30289,8,0,0},nCount=1,nRate=1.5},
	-- {szName="HuyÕt Long §»ng CÊp 9",tbProp={6,1,30289,9,0,0},nCount=1,nRate=3},
	-- {szName="HuyÕt Long §»ng CÊp 12",tbProp={6,1,30289,12,0,0},nCount=1,nRate=2},
	-- {szName="Long §¶m 20% (Cã thÓ gia h¹n)",tbProp={0,3499},nCount=1,nRate=0.01,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Long §¶m 30% (Cã thÓ gia h¹n)",tbProp={0,4856},nCount=1,nRate=0.008,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Long §¶m 40% (Cã thÓ gia h¹n)",tbProp={0,4857},nCount=1,nRate=0.005,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Cuång Lan 2% (Cã thÓ gia h¹n)",tbProp={0,3501},nCount=1,nRate=0.01,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Cuång Lan 3% (Cã thÓ gia h¹n)",tbProp={0,4860},nCount=1,nRate=0.006,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Cuång Lan 4% (Cã thÓ gia h¹n)",tbProp={0,4861},nCount=1,nRate=0.004,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Cuång Lan 5% (Cã thÓ gia h¹n)",tbProp={0,4862},nCount=1,nRate=0.002,nQuality = 1,nExpiredTime=10080,},
	...
	-- {szName="Thuèc t¨ng tr­ëng",tbProp={6,1,3454,1,0,0},nCount=1,nRate=0.2},
	-- {szName="MÆt n¹ chiÕn tr­êng V­¬ng Gi¶",tbProp={0,11,647,1,0,0},nCount=1,nRate=0.3,nExpiredTime=10080, nUsageTime = 60},
	-- {szName = "§iÓm Kinh NghiÖm", nExp=6000000,nRate=15.335},
...
tbAward_New = {--server míi
	...
	-- {szName="B¹ch Hæ Ph¸t Qu¸n - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={2,0,0,0,0,0}},
	-- {szName="B¹ch Hæ Kim Kh¶i - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.01,tbParam={6,0,0,0,0,0}},
	-- {szName="B¹ch Hæ H¹ng Liªn - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={1,0,0,0,0,0}},
	-- {szName="B¹ch Hæ Hé UyÓn - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={4,0,0,0,0,0}},
	-- {szName="B¹ch Hæ Ngäc Béi - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={9,0,0,0,0,0}},
	-- {szName="B¹ch Hæ Hµi - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={8,0,0,0,0,0}},
	-- {szName="B¹ch Hæ Yªu §¸i - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={5,0,0,0,0,0}},
	-- {szName="B¹ch Hæ Th­îng Giíi ChØ - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={3,0,0,0,0,0}},
	-- {szName="B¹ch Hæ H¹ Giíi ChØ - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.015,tbParam={10,0,0,0,0,0}},
	-- {szName="B¹ch Hæ KhÝ Giíi - Tù chän hÖ ph¸i",tbProp={6,1,30242,1,0,0},nCount=1,nRate=0.01,tbParam={7,0,0,0,0,0}},
	-- {szName="M¶nh XÝch L©n",tbProp={6,1,3391,1,0,0},nCount=1,nRate=1.5},
	-- {szName="XÝch L©n Kim Bµi",tbProp={6,1,3392,1,0,0},nCount=1,nRate=0.1},
	-- {szName="XÝch L©n LÖnh",tbProp={6,1,3393,1,0,0},nCount=1,nRate=0.1},
	...
	-- {szName="Ch©n Nguyªn §¬n (®¹i)",tbProp={6,1,30229,1,0,0},nCount=1,nRate=20,nBindState=-2},
	-- {szName="Hé M¹ch §¬n",tbProp={6,1,3203,1,0,0},nCount=20,nRate=10},
	...
	-- {szName="Long §¶m 20% (kh«ng thÓ gia h¹n)_4485",tbProp={0,4485},nCount=1,nRate=0.04,nQuality = 1,nExpiredTime=10080,},
	-- {szName="Cuång Lan 2% (kh«ng thÓ gia h¹n)_4489",tbProp={0,4489},nCount=1,nRate=0.04,nQuality = 1,nExpiredTime=10080,},
	...
	{szName = "§iÓm Kinh NghiÖm", nExp=6000000,nRate=11.615},
	{szName = "§iÓm Kinh NghiÖm", nExp=8000000,nRate=8},
...
{ --PhÇn th­ëng ®¹t mèc cè ®Þnh, server cò
	...
	-- ["1000"] = {
	-- 					{
	-- 						{szName="Phi Phong CÊp PhÖ Quang (hãa gi¶i s¸t th­¬ng)",tbProp={0,3477},nCount=1,nRate=50,nQuality = 1,nExpiredTime=20160,},
	-- 						{szName="Phi Phong PhÖ Quang ( träng kÝch)",tbProp={0,3478},nCount=1,nRate=50,nQuality = 1,nExpiredTime=20160,},							
	-- 					},
	-- 					{
	-- 						{szName="HuyÕt Long §»ng CÊp 5",tbProp={6,1,30289,5,0,0},nCount=10,nRate=20},
	-- 						{szName="HuyÕt Long §»ng CÊp 6",tbProp={6,1,30289,6,0,0},nCount=10,nRate=20},
	-- 						{szName="HuyÕt Long §»ng CÊp 8",tbProp={6,1,30289,8,0,0},nCount=10,nRate=20},
	-- 						{szName="HuyÕt Long §»ng CÊp 9",tbProp={6,1,30289,9,0,0},nCount=10,nRate=20},
	-- 						{szName="HuyÕt Long §»ng CÊp 12",tbProp={6,1,30289,12,0,0},nCount=10,nRate=20},
	-- 					},	
	-- 				},
	-- ["2000"] = {
	-- 					{szName="MÆt n¹ chiÕn tr­êng V­¬ng Gi¶",tbProp={0,11,647,1,0,0},nCount=1,nExpiredTime=10080,},
	-- 					{pFun = function (nItemCount, szLogTitle)	
	-- 						SetTask(4000, GetTask(4000) + 8000)
	-- 						Msg2Player(format("NhËn ®­îc %d ®iÓm Ch©n Nguyªn", 8000))
	-- 					 end},
	-- 					 {szName ="Hé M¹ch §¬n",tbProp={6,1,3203,1,0,0},nCount=4000,},
	-- 				},
}
...
{ --PhÇn th­ëng ®¹t mèc cè ®Þnh, server míi
	...
	-- 				Msg2Player(format("NhËn ®­îc %d ®iÓm Ch©n Nguyªn", 3000))
	-- 			end},
	-- 		},
	-- 		{
	-- 			{szName ="Hé M¹ch §¬n",tbProp={6,1,3203,1,0,0},nCount=2000},
	-- 		},
	-- 	},
	-- ["1000"] = {
	-- 					{szName="Phi Phon Ngù Phong (hãa gi¶i s¸t th­¬ng)",tbProp={0,3474},nCount=1,nQuality = 1,nExpiredTime=10080,},
	-- 					{szName="HuyÕt Long §»ng CÊp 5",tbProp={6,1,30289,5,0,0},nCount=10,},
	-- 				},
	-- ["2000"] = {
	-- 					{szName="Phiªn Vò ",tbProp={0,10,7,1,0,0},nCount=1,nExpiredTime=43200},
