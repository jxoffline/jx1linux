...
if (levelname == "statusimmunity_b") then
return Getstatusimmunity_b(level)
end;
...
function Getstatusimmunity_b(level)
return Param2String(1,-1,0)
end;

function Getfatallystrikeres_p(level)
return Param2String(95,-1,0)
end
