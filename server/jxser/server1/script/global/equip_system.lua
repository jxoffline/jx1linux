-- Chøc n¨ng: HÖ thèng chÕ t¹o tranng bŞ ®å tİm vµ hkmp - Editor by AloneScript (Linh Em)
...
function OnFoundry()
	Say( "NÕu ®¹i hiÖp muèn cã mét mãn ®å võa ı th× ®em ®Çy ®ñ nguyªn liÖu tíi ®©y. Ta sÏ ®óc luyÖn mét vËt phÈm ng­¬i thİch nhÊt!", 4,
	"B¾t ®Çu chÕ t¹o/OnFoundryEquip",
	"Liªn quan chÕ t¹o/OnAbout",
	"T×m hiÓu m¶nh Hoµng Kim/OnQueryPiece",
	"Ta sÏ quay l¹i sau./no");
end

function OnFoundryEquip()
	-- D¹ng 1: kh«ng thiÕt lËp thêi gian nghÜ ng¬i cho thî rÌn
		FoundryItem();
	-- D¹ng 2: thiÕt lËp thêi gian nghÜ ng¬i cho thî rÌn
		if( isCompoundableToday() == 1 ) then
			FoundryItem();
		else
			Say("L·o phu h«m nay mÖt råi, ngµy mai h·y ghĞ l¹i ®©y ®Ó ®óc trang bŞ nhĞ!",1, "§­îc, ngµy mai ta sÏ quay l¹i!")
		end
end
...
function OnAbout_2()
	Talk( 2, "OnCancel", "<color=yellow>Trang bŞ HuyÒn Tinh<color>: Dïng 1 trang bŞ mµu xanh hoÆc mµu tr¾ng kÕt hîp víi HuyÒn Tinh Kho¸ng Th¹ch chÕ t¹o sÏ cã c¬ héi nhËn ®­îc 1 Trang bŞ HuyÒn Tinh tõ 1~5 lÇn c¬ héi kh¶m n¹m. C¸c hµng thuéc tİnh kh¸c cña trang bŞ sÏ gièng víi nguyªn liÖu trang bŞ ®­îc sö dông.",
	"<color=yellow>§å phæ Hoµng Kim<color>: Mçi mét bé trang bŞ Hoµng Kim ®Òu cã nh÷ng ®å phæ Hoµng Kim t­¬ng øng, theo nh÷ng g× ghi l¹i trªn ®å phæ Hoµng Kim cã ®­îc b¹n sÏ t×m ®­îc c¸c mãn cßn l¹i kÕt hîp chóng thµnh bé trang bŞ Hoµng Kim." );
end