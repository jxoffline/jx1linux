...
TUREREFRESH_EXP = tonumber( TabFile_GetCell( "tollprize" ,9 ,"shuachu_exp"))  --Ğ¡¹Ö¾­Ñé
TUREREFRESH_MAPID= 394  --Ç§±¦¿âµÄµØÍ¼id
TUREREFRESH_MESSENGEREXP= tonumber( TabFile_GetCell( "tollprize" ,9 ,"shuachu_jifen"))  --Ğ¡¹Ö¾­Ñé
