...
-- 剑侠情缘online 情义江湖同伴修炼篇脚本实体处理文件 - 侍朗之死
-- Edited by peres
-- 2005/09/09 PM 11:19
...
PARID_REWIND_ITEM_001 = 33;    -- 地黄草
PARID_REWIND_ITEM_002 = 34;    -- 费叶
PARID_REWIND_ITEM_003 = 35;    -- 左钥匙
PARID_REWIND_ITEM_004 = 36;    -- 染胛骨
PARID_REWIND_ITEM_005 = 37;    -- 右钥匙

PARID_REWIND_WAITTIME = 38;   -- 5分钟的等待时间
...
rewindProcess_001 = inherit(CProcess, {
	...
	taskEntity = function(self, nCondition)
		...
		local strMain = {
			...
			"剧情篇[针对没有做过该任务的同伴]/#rewindProcess_001_01:doTaskEntity()",
			"修练篇[针对已经做过该任务的同伴]/#rewindProcess_001_02:doTaskEntity()",
...
rewindProcess_001_01 = inherit(CProcess, {
	...
	checkCondition = function(self)
		...
		if GetRewindTaskState(PARID_TASK_REWIND_001)==nil then -- 没有CALL同伴出来返回0
			return 0;
		elseif GetMasterTaskState(PARID_TASK_MASTER_001)<=4 then -- 没有完成剧情篇的任务的
			return 4;
		elseif CheckRewindState(1)~=1 then -- 不符合日期判断条件
			return 5;
		elseif GetRewindTaskState(PARID_TASK_REWIND_001)>=1 and GetRewindTaskState(PARID_TASK_REWIND_001)<5 then -- 已经开始了任务的返回1
			return 1;
		elseif GetRewindTaskState(PARID_TASK_REWIND_001)==5 then -- 已经完成过任务的返回2
			return 2;
		elseif GetRewindTaskState(PARID_TASK_REWIND_001)==0 then -- 从来没有做过这个任务的返回3
			return 3;
		end;
	end,
	...
	taskEntity = function(self, nCondition)
		...
		local strMain = {
			...
			"我愿意接受任务/#rewindProcess_001_Accept:doTaskEntity()",
			"容我再想想吧/OnTaskExit"
		}
...
rewindProcess_001_Pay = inherit(CProcess, {
	...
	taskEntity = function(self, nCondition)
		...
		strMain = {
			...
			"领取奖励/#rewindProcess_001_PayAward:doTaskEntity()"
		}
...
rewindProcess_001_Cancel = inherit(CProcess, {
	...
	taskEntity = function(self, nCondition)
		Say("你确定要取消侍郎之死的剧情任务吗？",2,
			"是的，我太疲惫了/#rewindProcess_001_Cancel_Confirm:doTaskEntity()",
			"让我再考虑一下/OnTaskExit");
		return 1;
	end,
...
rewindProcess_001_02 = inherit(CProcess, {
	...
	taskEntity = function(self, nCondition)
		strMain = {
			...
			"是的，我已经准备好了/#rewindProcess_001_02_Accept:doTaskEntity()",
...
rewindProcess_001_02_Accept = inherit(CProcess, {
	...
	taskEntity = function(self, nCondition)
		strMain = {
			...
			"清楚了，送我去吧/#rewindProcess_001_02_01:doTaskEntity()",
			"我再准备准备/OnTaskExit"
		}
	...
	taskEntity = function(self, nCondition)
		if nCondition==1 then
			SelectDescribe({"<npc>你手上拿着的钥匙就是你实力的凭证，我这就送你进去接受挑战吧！",
							"好，请送我进去吧/#rewindProcess_001_02_Inside:doTaskEntity()",
							"我再准备一下/OnTaskExit"
							});
		else
	...
	taskEntity = function(self, nCondition)
		if nCondition==1 then	
			SelectDescribe({"<npc>你现在想出去了吗？",
							"请送我出去吧/#rewindProcess_001_02_Outside:doTaskEntity()",
							"再等等/OnTaskExit",
							});
		end;
		return 1;
...
rewindProcess_001_02_06 = inherit(CProcess, {
	...
	taskEntity = function(self, nCondition)
		strMain = {
			...
			"结束对话/#rewindProcess_001_02_07:doTaskEntity()"
		}
		if nCondition==1 then
			SelectDescribe(strMain);
			return 1;
