...
function TaskShedule()
	...
	TaskCountLimit(0)
	OutputMsg("==========================================================");
	OutputMsg("[Start] Ho¹t ®éng H¸i Qu¶ Hoµng Kim 20:00 -> 20:30");
end
...
function TaskContent()
	...
	if righttime_add() ~= 1 then
		...
		gb_SetTask("h¹t Huy Hoµng", 12, 0);
		return
	end;
	
	OutputMsg("Ho¹t §éng §ªm Huy Hoµng H¸i Qu¶")
	...
	for i = 1, nMapCount do
		...
		szMsg = format("HiÖn t¹i <%s> ®· xuÊt hiÖn t¹i %s, 5 phót sau sÏ kÕt qu¶. C¸c vÞ ®¹i hiÖp h·y chuÈn bÞ h¸i qu¶.",szMsg,greatseed_configtab[i][5]);
