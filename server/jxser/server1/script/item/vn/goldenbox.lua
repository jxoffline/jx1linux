...
function main(nItemIdx)
	...
	local tb_goldenbox = {
								...
								{1,	{6,1,147,3,0,0},	1,	10320,	"HuyÒn Tinh Kho¸ng Th¹ch cÊp 3 ", 0},
								{1,	{6,1,26,1,0,0,0},	1,	100,	"Vâ L©m MËt TŞch", 0},
								{1,	{6,1,22,1,0,0,0},	1,	100,	"TÈy Tñy Kinh", 0},
								{1,	{6,1,147,4,0,0},	1,	100,	"HuyÒn Tinh Kho¸ng Th¹ch cÊp 4", 0},
								{2,	{0,164},	1,	20,	"An Bang B¨ng Tinh Th¹ch H¹ng Liªn", 1},
								{2,	{0,165},	1,	20,	"An Bang Cóc Hoa Th¹ch ChØ hoµn", 1},
								{2,	{0,166},	1,	20,	"An Bang §iÒn Hoµng Th¹ch Ngäc Béi", 1},
								{2,	{0,167},	1,	20,	"An Bang Kª HuyÕt Th¹ch Giíi ChØ ", 1},
								{1,	{6,1,147,5,0,0},	1,	20,	"HuyÒn Tinh Kho¸ng Th¹ch cÊp 5", 0},
								{2,	{0,159},	1,	20,	"§Şnh Quèc Thanh Sa Tr­êng Sam", 1},
								{2,	{0,160},	1,	20,	"§Şnh Quèc ¤ Sa Ph¸t Qu¸n", 1},
								{2,	{0,161},	1,	20,	"§Şnh Quèc Xİch Quyªn NhuyÔn Ngoa", 1},
								{2,	{0,162},	1,	20,	"§Şnh Quèc Tö §»ng Hé uyÓn", 1},
								{2,	{0,163},	1,	20,	"§Şnh Quèc Ng©n Tµm Yªu ®¸i", 1},
		};
	local sum = 0;
	...
	for i = 1, getn(tb_goldenbox) do
		...
		if (sum >= nrand) then
			...
			WriteLog(strInfo..format("Më R­¬ng vµng nhËn ®­îc %s", tb_goldenbox[i][5]));
