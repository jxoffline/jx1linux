...
szScript = "\\script\\skill\\special\\spider_web.lua"
...
function OnMagicAttrib(nCallState, nTargetNpcIndex, nLauncherNpcIndex)
	...
	Msg2Map(SubWorldIdx2ID(nMapIndex), format("%s bÞ Ngò S¾c Long Thï nh¶ ra t¬ ®éc quÊn quanh, nhanh chãng ®¸nh tan nã, nÕu kh«ng 15 gi©y sau sÏ bÞ tróng ®éc mµ chÕt.", szName, szName))
end
