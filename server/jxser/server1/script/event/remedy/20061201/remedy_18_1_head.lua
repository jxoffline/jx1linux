...
function Remedy_20061031_Main()
	Say("礼官：您要领取12月份 18 区 1 停机维护的补偿经验吗？此次经验补偿的领取日期为 <color=yellow>2006年12月1日 至 2006年12月07日，50级以上每人限领一次<color>。", 
		2,
...
function Remedy_20061031_Get()
	...
	local szErrotMsg = "";
		...
		if nResult==1 then
			Say("礼官：您已经成功领取了 18 区 1 停机维护补偿经验，此类经验是<color=yellow>升级之后仍然叠加<color>的，祝您今天有个好运气。", 0);
			return 1;
		else
