...
function PickUp( nItemIndex, nPlayerIndex )
	...
	if(size < 2) then --
		Msg2Player("B¹n ®­îc 1 Uyªn ¦¬ng MËt, nh­ng kÎ c« ®¬n nh­ b¹n kh«ng thÓ më c«ng n¨ng cña thÎ nµy!")
		PlayerIndex = oldPlyIdx
		return 0
	end
	if(size > 2) then
		Msg2Player("B¹n ®­îc 1 Uyªn ¦¬ng MËt, nh­ng nhiÒu ng­êi thÕ, b¹n kh«ng biÕt cïng ai ®Ó më c«ng n¨ng cña thÎ nµy!")
		PlayerIndex = oldPlyIdx
		return 0
	end
	...
	if(otherSex == mySex) then
		Msg2Player("B¹n ®­îc Uyªn ¦¬ng MËt, nh­ng kh«ng thÓ më c«ng n¨ng cña thÎ cho hai b¹n cïng giíi!")
		PlayerIndex = oldPlyIdx
		return 0
	end
	if(myCode == otherCode and myCode ~=0) then  --ÑéÖ¤ÂëÏàÍ¬
		if(myNum == otherNum) then --ÓÐÇéÈË£¬¿¨µÄÊýÁ¿Ò»Ñù¡£
			...
			otherNum = myNum
			Msg2Player("B¹n ®­îc Uyªn ¦¬ng MËt, gióp cho duyªn phËn cña b¹n vµ     "..otherName.."thªm gÇn nhau h¬n. HiÖn nay, b¹n ®· tÝch lòy"..myNum.."Uyªn ¦¬ng MËt.")
			AddOwnExp(myLevel * (20+0.1*myLevel)-10)
			SetTask(TID_CARDNUMBER,SetByte(GetTask(TID_CARDNUMBER),GETBYTE,myNum)) --»ØÐ´ÐÅÏ¢
			PlayerIndex = otherIndex
			Msg2Player(myName.."®­îc 1 Uyªn ¦¬ng MËt, gióp cho duyªn phËn cña c¸c b¹n thªm gÇn nhau h¬n. HiÖn nay, b¹n ®· tÝch lòy"..otherNum.."Uyªn ¦¬ng MËt.")
			...
			if(myNum > 98) then --´ïµ½99¸ö£¬Óë×ÓÙÉÀÏÀ²
				...
				Msg2Player("B¹n ®· tÝch lòy ®­îc 99 Uyªn ¦¬ng MËt! B¹n vµ "..otherName.."cïng më c«ng n¨ng cña thiÖp nµy. B¹n nhËn ®­îc t¨ng thªm 30 ®iÓm may m¾n trong 2 giê.")
				SetTask(TID_CARDNUMBER,SetByte(GetTask(TID_CARDNUMBER),GETBYTE,myNum)) --»ØÐ´ÐÅÏ¢
				PlayerIndex = otherIndex
				AddSkillState(530,15,1,2*60*60*18)
				AddSkillState(533,1,1,2*60*60*18)
				Msg2Player("B¹n ®· tÝch lòy ®­îc 99 Uyªn ¦¬ng MËt! B¹n vµ "..myName.."cïng më c«ng n¨ng cña thiÖp nµy. B¹n nhËn ®­îc t¨ng thªm 30 ®iÓm may m¾n trong 2 giê.")
				SetTask(TID_CARDNUMBER,SetByte(GetTask(TID_CARDNUMBER),GETBYTE,myNum)) --»ØÐ´ÐÅÏ¢
			end
			PlayerIndex = oldPlyIdx
			return 0
		...
		PlayerIndex = nPlayerIndex
		Msg2Player("B¹n ®­îc 1 Uyªn ¦¬ng MËt, cïng"..otherName.."duyªn phËn thªm gÇn nhau h¬n. B¹n hiÖn ®· tÝch lòy ®­îc"..myNum.."Uyªn ¦¬ng MËt.")
		SetTask(TID_CARDNUMBER,SetByte(GetTask(TID_CARDNUMBER),GETBYTE,myNum)) --»ØÐ´ÐÅÏ¢
		PlayerIndex = otherIndex
		Msg2Player(myName.."®­îc 1 Uyªn ¦¬ng MËt, duyªn phËn cña b¹n thªm gÇn nhau h¬n. HiÖn nay, b¹n tÝch lòy ®­îc"..otherNum.."Uyªn ¦¬ng MËt.")
	...
	Msg2Player("B¹n ®­îc 1 Uyªn ¦¬ng MËt, ®ång thêi cïng"..otherName.."b¾t ®Çu b¾t ®Çu cuéc t×nh duyªn. ")
	SetTask(TID_VALIDATION,code)
	PlayerIndex = otherIndex
	Msg2Player(myName.."­îc 1 Uyªn ¦¬ng MËt, ®ång thêi cïng b¹n b¾t ®Çu cuéc t×nh duyªn.")
	SetTask(TID_VALIDATION,code)
	PlayerIndex = oldPlyIdx
	return 0
end
