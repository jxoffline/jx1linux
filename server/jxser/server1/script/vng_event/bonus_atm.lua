...
BonusATM2011 = {}
--Gia h¹n nhËn th­ëng ®Õn hÕt ngµy 18/12/2011 - Modified By DinhHQ - 20111213
...
function BonusATM2011:GetAward()
	...
	if (CalcFreeItemCellCount() < 5 ) then
	 ...
	 local tbAward = {szName = "Hång Bao An Khang", tbProp = {6,1,2105,1,0,0}, nCount = 1, nExpiredTime = 86400}
...
if (BonusATM2011:IsActive() ~= 0) then
	nId = pEventType:Reg("LÔ Quan", "NhËn th­ëng Hång Bao An Khang", BonusATM2011.GetAward,{BonusATM2011})
end	